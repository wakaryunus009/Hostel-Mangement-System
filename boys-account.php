    ...
    <section class="section">
        <div class="section-body">
            <div class="row">
                ...
                <div class="col-9" style="top:30px; right:8px;">
                    <div class="card">
                        <div class="card-header">
                            <!--<div class="row">-->
                                <div class="col-md-12">
                                   <h2 style='text-align:center;' class='mt-4 mb-4'>Welcome to Boys Section</h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM `room` WHERE department='male'";
                                        $result = $db->query($sql);
